...
import {
  ...
  deleteTugasController,
  listSubmisiController,
  cekSubmisiController,
  submitTugasController,
  beriNilaiTugasController,
...
router.patch(
  '/:id/submisi/:submisiId/nilai',
  requireRole('GURU'),
  validate(NilaiTugasSchema),
  beriNilaiTugasController,
);
