...
import { deleteAkunAction } from "../actions/delete-akun.action";

export function DeleteAkunDialog() {
  const { deleteTargetId, deleteTargetName, closeDeleteDialog } =
    useAkunUIStore();
  ...
  function handleDelete() {
    startTransition(async () => {
      await handleAction(await deleteAkunAction(deleteTargetId!), {
